...
public class Program
{
    ...
    public static bool IsPalindrome(string stroka)
    {
        ...
        string cleanedString = stroka.Replace(" ", "").ToLower();
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("Является ли 'hello' палиндромом: " + IsPalindrome("hello"));
        Console.WriteLine("Является ли 'level' палиндромом: " + IsPalindrome("level"));
        Console.WriteLine("Является ли 'А роза упала на лапу Азора' палиндромом: " + IsPalindrome("А роза упала на лапу Азора"));
